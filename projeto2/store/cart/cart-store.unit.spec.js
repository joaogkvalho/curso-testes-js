...
describe('Cart Store', () => {
  ...
  it('should return open equals false on inital state', async () => {
    expect(result.current.state.open).toBe(false);
  });

  it('should return an empty array for products on inital state', () => {
  ...
  it('should assign 1 as inital quantity on product add', () => {
  ...
  it('should NOT decrease quantity bellow zero', () => {
    const product = server.create('product');
